...
try {
    ...
    if ($TestReport -or -not $TestOutlook) {
        ...
        # Add some test data
        Add-SuccessfulApplication -ApplicationId "TestApp1" -DisplayName "Adobe Acrobat Reader DC" -Version "2024.001.20643" -Action "Updated"
        Add-SuccessfulApplication -ApplicationId "TestApp2" -DisplayName "Google Chrome" -Version "120.0.6099.216" -Action "Force Updated"
